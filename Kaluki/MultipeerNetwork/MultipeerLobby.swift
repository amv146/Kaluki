...
//    func updatedLobbyInfo(players: [FirebasePlayer], round: Int)
// }
//
...
//    }
//
//    func addPlayer(playerInfo: FirebasePlayer) {
//        players.append(playerInfo)
//    }
//
//    func isHost(playerInfo: FirebasePlayer = MultipeerNetwork.player.info) -> Bool {
...
//    }
//
//    func removePlayer(playerInfo: FirebasePlayer) {
...
//    }
//
////    func sendPlayerJoinedLobbyToHost(playerInfo: FirebasePlayer) {
...
////    }
////
////    func sendNewPlayerInfo(playerInfo: FirebasePlayer) {
...
////    }
////
////    func sendLobbyInfo(joinedPlayer peerID: MCPeerID?, players: [FirebasePlayer]) {
////        print(players)
